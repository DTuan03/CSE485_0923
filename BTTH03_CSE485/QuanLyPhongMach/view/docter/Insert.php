...
<div class="container-fliud">
    <div class="row mt-4 d-block text-center">
        <div class="col-md-4 d-inline-block">
            ...
            <form action="<?= DOMAIN . '/public/index.php?mod=controller&route=docter&act=InsertController' ?>" method="POST" class="mt-4">
                <div class="mb-3">
                    <label for="" class="form-label">Tên bác sĩ</label>
                    <input type="text" name="nameDocter" class="w-75">
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Chuyên khoa</label>
                    <input type="text" name="specialty" class="w-75">
                </div>
