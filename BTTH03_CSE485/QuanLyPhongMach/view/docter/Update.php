...
<div class="container-fliud">
    <div class="row mt-4 d-block text-center">
        <div class="col-md-4 d-inline-block">
            ...
            <form action="<?= DOMAIN . '/public/index.php?mod=controller&route=docter&act=UpdateController' ?>" method="POST" class="mt-4">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tenDocter" class="w-75" value="<?= $_GET['nameDocter'] ?>">
                </div>
                <div class="mb-3">
                    <label for="" class="form-label">Chuyên khoa</label>
                    <input type="text" name="specialty" class="w-75" value="<?= $_GET['specialty'] ?>">
                </div>
            ...
            <script>
                function goBack() {
                    ...
                    window.location.href = "<?= DOMAIN . '/public/Index.php?mod=controller&route=docter&act=ViewController' ?>";
                }
            </script>
        </div>
    </div>
